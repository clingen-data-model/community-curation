...
class FaqsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $faqs = [
            ...
            'How do I change or add an Expert Panel that I am interested in to my  priorities?' => 'Go to the “Priorities” tab, in the bottom left corner click on “Set New Priorities”. In the window that pops up change the Expert Panel under “First Choice” to your new prioritized Expert Panel. Click “Finish and Finalize”.',
            'How do I indicate that I am willing to volunteer for ClinGen outside of the curation efforts and Expert Panels that I prioritized?' => 'Go to the “Priorities” tab, in the bottom left corner click on “Set New Priorities”. In the window that pops up change the last question to “Yes - I am willing to volunteer with any available ClinGen group- I am willing to volunteer with any available ClinGen group. Click “Finish and Finalize”.',
