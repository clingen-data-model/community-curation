...
class VolunteerSearchServiceTest extends TestCase
{
    ...
    public function it_can_filter_by_is_logged_in()
    {
        ...
        $countBefore = $searcher->search(['is_logged_in' => 1])->count();
        ...
        $this->assertEquals($countBefore + 1, $loggedInUsers->count());
        $this->assertContains($volunteers->first()->id, $loggedInUsers->pluck('id'));
    }
}
