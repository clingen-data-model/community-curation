        ...
        return {
            questions: [
                ...
                },
                {
                    ...
                    question: "I have reviewed the Baseline Annotation Protocol Review and understand this resource.",
                    value: null,
                    required: "true",
                },
                {            
                    name: "watched_variants_and_nomenclature",
                    question: "I have watched the “Introduction to Variants and Nomenclature” video and understand this process.",
                    value: null,
                    required: "true"
                },
                {
                    name: "watched_into_to_genome_build_and_transcripts",
                    question: "I have watched the “Introduction to genome builds and transcripts” video and understand this process." ,
                    value: null,
                    required: "true"
                },
                {
                    name: 'watched_allele_registry_overview',
                    question: "I have watched the “Basic Overview of using the ClinGen Allele Registry” video and understand this resource.",
                    value: null,
                    required: true
                },
                {
                    name: 'watched_utilizing_clinvar',
                    question: 'I have watched the “Utilizing ClinVar for Allele Identifiers” video and understand this resource.',
                    value: null,
                    required: true
                },
                {
