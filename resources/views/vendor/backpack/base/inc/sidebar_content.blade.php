...
@can('list users')
    <li class="nav-item">
        <a class="nav-link" href="{{ backpack_url('volunteer') }}">
...
@can('list curation-groups')
    <li class="nav-item">
        <a class="nav-link" href="{{ backpack_url('curation-group') }}">
            <i class="nav-icon la la-group"></i>
            <span>Curation groups</span>
        </a>
    </li>
@endcan

@can('list custom-surveys')
<li class="nav-item">
    <a class="nav-link" href="{{ backpack_url('custom-survey') }}">
...
@can('list volunteer-types')
    <li class="nav-item">
        <a class="nav-link" href="{{ backpack_url('volunteer-type') }}">
            <i class="nav-icon la la-list"></i>
            <span>Volunteer types</span>
        </a>
    </li>
@endcan
...
@can('list genes')
    <li class="nav-item">
        <a class="nav-link" href="{{ backpack_url('gene') }}">
            <i class="nav-icon la la-list"></i>
            <span>Genes</span>
        </a>
    </li>
...
@can('list lookups')
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ backpack_url('interest') }}">
            <i class="nav-icon la la-list"></i>
            <span>Interests</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ backpack_url('motivation') }}">
            <i class="nav-icon la la-list"></i>
            <span>Motivations</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ backpack_url('self-description') }}">
            <i class="nav-icon la la-list"></i>
...
<li class="nav-item">
    <a class="nav-link" href="{{ backpack_url('upload-category') }}">
        <i class="nav-icon la la-list"></i>
...
<li class="nav-item">
    <a class="nav-link" href="{{backpack_url('faq')}}">
        <i class="nav-icon la la-question"></i><span>FAQ</span></a>
</li>
<li class="nav-item">
